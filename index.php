...
<section>
  <div id="adbox">
      ...
      <div class="container p-0 nav-bar">
      <img  src="http://localhost:81/zerotype/Admin/<?php echo $se['img'] ?>" height="342" width="368">
      <div>
        <h1>Zerotype</h1>
