	...
	<div id="contents">
			...
			<ul class="news">
				<li>
					<div class="date">
						<p>
							<span><?php echo $se['month']; ?></span>
							<?php echo $se['year']; ?>
						</p>
					</div>
					<h2 style="color:#444444;">Updates:

						 <?php echo $se['caption']; ?> <br> <span  style=" font-size:16px; font-weight:normal; "Times New Roman", Times, serif"><?php echo $se['address']; ?></span></h2>
					<p>
						 <?php echo substr ($se['conten'],0,100); ?>...
						<span><a href="post.php?post=<?php echo $se['id'];?>" class="more">Read More</a></span>
					</p>
				</li>
			</ul>
		<?php } ?>
